...
urlpatterns = [
    ...
    path(
        "anime/export/csv/", views.export_anime_csv, name="export_anime_csv"
    ),
    # --- Webtoon URL'leri ---
    ...
    path(
        "webtoon/<int:pk>/delete/", views.webtoon_delete, name="webtoon_delete"
    ),
    path(
        "webtoon/export/csv/",
        views.export_webtoon_csv,
        name="export_webtoon_csv",
    ),
    # --- Manga URL'leri ---
    ...
    path(
        "manga/export/csv/", views.export_manga_csv, name="export_manga_csv"
    ),
    # --- Novel URL'leri ---
    ...
    path(
        "novel/export/csv/", views.export_novel_csv, name="export_novel_csv"
    ),
]